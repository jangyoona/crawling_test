    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/wb365/notice/multiImageUploader.do'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/file/singleImageUploader.do',	//샘플 URL입니다.
 	        sCallback : '/resources/js/smart_editor/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
