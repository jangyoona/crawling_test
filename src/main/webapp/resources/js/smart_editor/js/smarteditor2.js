...
nhn.husky.SE2B_CSSLoader = jindo.$Class({
	...
	*/
	...
	loadSE2CSS : function(sMsg, oArgs){
		...
		console.log(this.htOptions.sCSSBaseURI)
...
var oMessageMap_en_US = {
	'SE_EditingAreaManager.onExit' : 'The content has changed.',
	'SE_Color.invalidColorCode' : 'Please enter the correct color code. \n\n Ex) #000000, #FF0000, #FFFFFF, #ffffff, ffffff',
	'SE_Hyperlink.invalidURL' : '입력하신 URL이 올바르지 않습니다.',
	'SE_FindReplace.keywordMissing' : 'The URL you entered is incorrect.',
	'SE_FindReplace.keywordNotFound' : 'No words found.',
	'SE_FindReplace.replaceAllResultP1' : 'Total matches ',
	'SE_FindReplace.replaceAllResultP2' : 'thing has changed.',
	'SE_FindReplace.notSupportedBrowser' : 'This function is not available in the browser you are currently using.\n\nWe apologize for the inconvenience.',
	'SE_FindReplace.replaceKeywordNotFound' : 'No words to change',
	'SE_LineHeight.invalidLineHeight' : 'Invalid value.',
	'SE_Footnote.defaultText' : 'Please enter footnote content',
	'SE.failedToLoadFlash' : 'The flash is blocked and the function cannot be used.',
	'SE2M_EditingModeChanger.confirmTextMode' : 'When you switch to text mode, the written content is preserved, \n\nAll editing effects such as fonts and attachments such as images will disappear.\n\nDo you want to switch?',
	'SE2M_FontNameWithLayerUI.sSampleText' : 'ABCabc'
};
